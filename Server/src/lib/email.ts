...
export const sendWelcomeEmail = async ({ 
  toEmail, 
  name = 'there',
  message = "Thank you for joining our waitlist! We're working hard to build something amazing, and you'll be among the first to know when we launch. Your support means the world to us! 🌟"
}: WelcomeEmailOptions) => {
  try {
    const data = await resend.emails.send({
      from: 'BetterDrive <onboarding@resend.dev>',
      to: [toEmail],
